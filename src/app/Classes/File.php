...
class File
{
    ...
    public function __construct($binder, $localPath)
    {
        ...
        // '/path/to/laravel/project/resources/vendor/scribo/src/default/chapter-1/section-1/page-1.md'
    ...
    private function getPathname()
    {
        return is_null($this->splFileInfo)
            ? implode('/', [config('scribo.paths.src'), $this->binder->getRoutePrefix(), "{$this->localPath}.md"])
